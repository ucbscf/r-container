...
## in this case R 4.1.2
## This creates the files {cran,bioc,later}_packages-4.1.2.csv

Rscript -e "source('find_packages_4.1.2.R')"

## testing
## docker run -it --rm rocker/r-ver:4.1.2
